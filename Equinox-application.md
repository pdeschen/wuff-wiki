Let's build equinox application with wuff. We will build from scratch, in isolated environment (i.e. outside of wuff sources). All we have is JDK, gradle and access to jcenter.
